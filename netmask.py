...
host_bits = 32 - int(UserInput)
if UserInput != '32':
    total_addresses=2**host_bits
    usuable_addresses=total_addresses - 2
else:
    total_addresses = 1
    usuable_addresses = 0
...
netmask = str(lookUps[UserInput])[2:-2]
print ("Addresses: " + str(total_addresses) + " usuable: " + str(usuable_addresses) + " netmask: " + netmask)